...
unlocked to sign the Motion-Qt.app bundle.
...
allowing somebody to distribute a Motion-Qt.app or motion-qt-setup.exe with a valid
...
that the motion-qt.exe file inside the installer had not been tampered with.
