...
This document provides guidelines for internationalization of the Motion Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `motion_en.ts` remains unchanged.
