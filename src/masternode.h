...
// static std::map<int, int> masternodeTiers = map_list_of (1, 1000) (2, 2000); // 1k, 2k
...
public:
    ...
    /// Is the input associated with collateral public key? (and there is 1000 MOTION - checking if valid masternode)
