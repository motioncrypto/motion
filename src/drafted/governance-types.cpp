...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "MotionNetwork") type = MotionNetwork;
    if(strType == "MotionNetworkVariable") type = MotionNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == MotionNetwork) s = "MotionNetwork";
    if(type == MotionNetworkVariable) s = "MotionNetworkVariable";
