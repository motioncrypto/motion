...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1522288293, 944031, 0x1e0ffff0, 1, 1051200 * COIN);
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  0, uint256S("0x00000fa43a87286840b93955cd88909ce2b4f758d68433436b1f94f2788f58ee")),
            1522288293, // * UNIX timestamp of last checkpoint block
...
public:
    CTestNetParams() {
        ...
        vAlertPubKey = ParseHex("0423f13b049ac2b024f43fdf2176879dffcd78c7f8254848eebbc6d8d7a11da08fce0968994fadc22b51344dadb4e5c7e09c38c84524d0d36ac7ce963b41a2f2de");
        nDefaultPort = 17979;
        nMaxTipAge = 0x7fffffff; // allow mining on top of old blocks for testnet
        nDelayGetHeadersTime = 24 * 60 * 60;
        nPruneAfterHeight = 1000;

        genesis = CreateGenesisBlock(1525205784UL, 1168012UL, 0x1e0ffff0, 1, 150000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00000c8076be275104c734e701b34ecd1b08304bf775d992a3c12932da6f797a"));
        ...
        // checkpointData = (CCheckpointData) {
        //     boost::assign::map_list_of
        //     (  0, uint256S("0x00000c8076be275104c734e701b34ecd1b08304bf775d992a3c12932da6f797a"))
        //     ( 22520, uint256S("00000002c95eb91831bb7cb51ba6f5f39311b76280720f3aa02f8fafbeda0993")),
        //     1525205784, // * UNIX timestamp of last checkpoint block
