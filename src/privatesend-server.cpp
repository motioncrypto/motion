...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Motion related functionality
...
/*
    ...
    allow endless transaction that would bloat Motion and make it unusable. To
