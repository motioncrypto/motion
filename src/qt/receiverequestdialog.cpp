...
#include "config/motion-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatMotionURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + MotionUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatMotionURI(info));
}
