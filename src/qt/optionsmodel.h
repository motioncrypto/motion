...
#ifndef MOTION_QT_OPTIONSMODEL_H
#define MOTION_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for Motion client.
...
#endif // MOTION_QT_OPTIONSMODEL_H
